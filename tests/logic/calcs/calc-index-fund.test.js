    ...
    describe('usd currency', function () {
        ...
        test('absolute method', function () {
            expect(calcIndexFund(datasets, Object.assign({}, optionsUsd, {
                ...
                {
                    value: 0.0490, // (4100 - 4000) * 100 / 4000 / 51
                    date: dates[1],
                },
                {
                    value: 0.1196, // (4200 - 4000) * 100 / 4000 / 52 + (4200 - 4100) * 50 / 4100 / 52
                    date: dates[2],
                },
                {
                    value: 0.1875, // (4300 - 4000) * 100 / 4000 / 53 + (4300 - 4100) * 50 / 4100 / 53
                    date: dates[3],
                },
            ]);
        });
        ...
        test('absolute-total method', function () {
            expect(calcIndexFund(datasets, Object.assign({}, optionsUsd, {
                ...
                {
                    value: 2.9902, // 100 / 4000 * 4100 / 51 + 50 / 4100 * 4100 / 51
                    date: dates[1],
                },
                {
                    value: 3.0042, // 100 / 4000 * 4200 / 52 + 50 / 4100 * 4200 / 52
                    date: dates[2],
                },
                {
                    value: 3.0177, // 100 / 4000 * 4300 / 53 + 50 / 4100 * 4300 / 53
                    date: dates[3],
                },
            ]);
        });
